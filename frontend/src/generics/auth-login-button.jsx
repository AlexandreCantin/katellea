...
export default class AuthLoginButtons extends Component {
  ...
  render() {
    ...
    return (
      <>
        <p className="account-introduction">En créant un compte, vous pourrez : consulter votre historique de dons, gérer vos périodes d'indisponibilité ou encore créer un réseau privé pour vos dons !</p>
