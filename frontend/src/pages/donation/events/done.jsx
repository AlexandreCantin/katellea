  ...
  render() {
    ...
    return (
      <div className="event donation-done">
        <p className="block">Votre don vient de passer au status <strong>réalisé</strong>.</p>
        <p className="block">Le créateur du don a désormais 5 jours pour modifier les participants finals au don (si besoin).</p>
        <p className="block">Passé ce délai, ce don sera compatabilisé dans les statistiques des participants et globales du site.</p>
